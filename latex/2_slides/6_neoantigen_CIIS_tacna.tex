...
\begin{document}
	...
	\begin{frame}{Immunotherapy to Treat Cancer}{}		
		...
		\begin{figure}
			\includegraphics[width=0.6\textwidth]{../img/neoantigen/tcell}
	...
	\begin{frame}{Immunotherapy for Cancer}{Personalized Vaccines}	
		\begin{figure}
			\includegraphics[width=0.5\textwidth]{../img/neoantigen/process}
	...
	\begin{frame}{Immunotherapy for Cancer}{Personalized Vaccines}	
		\begin{figure}
			\includegraphics[width=0.4\textwidth]{../img/pipeline/pipeline_ingles}
	...
	\begin{frame}{pMHC binding prediction}{}		
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../img/neoantigen/mhc1.jpg}
...
\begin{frame}{Databases}{}
	...
	\begin{figure}[]
		\centering\includegraphics[width=0.6\textwidth]{../img/proposal/dataset_samples}
		\caption{
...
\begin{frame}{Results}{(Training for 3 epochs)}
	\begin{figure}
		\centering		
			\includegraphics[width=0.5\textwidth]{../img/results/metrics_comparion_by_model}			
...
\begin{frame}{Results}{Comparison with state-of-art tools}
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{../img/results/metrics_comparison}
...
\begin{frame}{Results}{Comparison with state-of-art tools}
	\begin{figure}
		\includegraphics[width=0.5\textwidth]{../img/results/ROC_comparison}
