...
\begin{figure}[h]
	\centering
	\subfigure[Comparación por modelo.]{\label{fig:a}\includegraphics[width=0.7\textwidth]{img/results/metrics_comparion_by_model}}
	\subfigure[Comparación por la metodología de entrenamiento.]{\label{fig:b}	\includegraphics[width=0.7\textwidth]{img/results/metrics_comparion_by_type}}
...
\section{Entrenamiento por 30 \textit{epochs}}
