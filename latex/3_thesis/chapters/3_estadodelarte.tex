...
En este capítulo presentamos los trabajos relacionados sobre detección de neoantígenos utilizando \textit{Transformers}. Adicionalmente, hemos incluído los \textit{pipelines} desarrollados y pruebas clínicas de aplicación de vacunas personalizadas para demostrar la efectividad e importancia de investigaciones basadas en neoantígenos.
...
El enfoque principal se centra en la priorización de neoantígenos (ver Figura 	\ref{fig:etapas}), ya que esta área ha sido objeto de una cantidad significativa de investigaciones que utilizan \textit{Transformers}. Sin embargo, hemos incluído un análisis de \textit{pipelines} y estudios de ensayos clínicos para obtener información sobre los hallazgos más recientes en cuanto a la aplicación de la detección de neoantígenos en vacunas personalizadas contra el cáncer. 
...
\begin{itemize}
	...
	\item  \textbf{Q4}.  ¿Que pruebas clínicas, de vacunas personalizadas de neoantpigenos, han sido aplicadas?
...
En la Tabla \ref{tab:criterios}, presentamos los criterios de inclusión y exclusión considerados para obtener los artículos relacionados a la tésis.
	...
	\begin{center}
		...
		{\renewcommand{\arraystretch}{1.5}% for the vertical padding
			\begin{tabular}{p{6cm}p{6cm}}
				...
				Artículos en revistas Q1 o Q2 según Scimago o Conferencias ERA (A o B). & Artículos de Conferencias de bajo nivel o no rankeadas.  \\
...
La detección de neoantígenos es una área multidisciplinaria que involucra a las ciencias de la computación, biología molecular y medicina. Debido a eso, existe una gran cantidad de artículos relacionados a neantígenos y esto puede presentar sesgos en algunas publicaiones no identificadas. Para disminuir este sesgo, se ha seguido las principales etapas de la metodología PRISMA; se desarrollado cuidadosamente varias cadenas de busqueda que retornaban la mayoría de publicaciones, se ha incluído todos los sinóminos conocidos y se ha enfatizado en realizar las busquedas en Scopus y Pubmed, por ser estas donde la mayoría de publicaciones se indexan. Como resultado, se ha obtenido dos publicaciones: \textit{``Deep Learning and Transformers in MHC-Peptide Binding and Presentation Towards Personalized Vaccines in Cancer Immunology: A Brief Review''} \citep{machaca2023deep} y \textit{``Transformers Meets Neoantigen Detection: A Systematic Literature Review''}.
...
\begin{table}[ht]
	...
	{\renewcommand{\arraystretch}{1.1}% para el espaciado vertical
		...
		\begin{tabular}{p{2.5cm}p{2.5cm}p{2cm}p{6.2cm}}
			...
			\cite{cai2022atm}	&	ATM-TCR	&	\textit{One-hot}	\& BLOSUM &	Consta de dos \textit{encoders} y un \textit{decoder} lineal. % para determinar la afinidad de unión.
			...
			%2022\cite{liu2021deepseqpanii}	&	DeepSeqPanII	&	\textit{One-hot} \& BLOSUM62	&   
			...
			\cite{xu2021dlptcr}	&	DLpTCR	&	\textit{One-hot}	&    DLpTCR consiste una red totalmente conectada, LeNet-5 y ResNet-20 para predecir la unión péptido-CDR3$\alpha$($\beta$). También implementa un mecanismo de atención en ResNet-20.% para mejorar la calidad de las salidas generadas.
			\\
	...
	{\renewcommand{\arraystretch}{1.5}% for the vertical padding
		{\scriptsize
			\begin{tabular}{lp{2cm}p{2cm}p{2cm}p{5cm}}
				\textbf{Nombre} &  \textbf{Referencia} & \textbf{Entrada} & \textbf{Salida} & \textbf{Herramientas} \\ \midrule
...
\begin{table}[h]
	\caption{Lista de pruebas clínicas que han utilizado vacunas personalizadas basadas en neantígenos desde el 2028. M: muestra, FC: Fase de Cancer, FE: Fase de ensayo. }
	...
	{\renewcommand{\arraystretch}{1.5}% for the vertical padding
		{\scriptsize
			\begin{tabular}{p{2.8cm}p{0.5cm}p{2.3cm}p{4.5cm}p{1.5cm}p{0.5cm}}
				\textbf{Referencia} & \textbf{M} & \textbf{Tiempo} & \textbf{Tipo de Cancer} & \textbf{FC} & \textbf{FE} \\ \midrule
				...
				\cite{holm2022neoantigen} & 24  & 12 meses followed up to 5 años  & Urothelial carcinoma & Advanced & II \\
				...
				\cite{wang2022therapy} & 20  & 5 años since Jul 2019 & Genomic Unstable Solid Tumors &- & I \\
				
				\cite{ellingsen2022characterization} & 12  & Oct 2015 follow-up for 5 años & Melanoma & Advanced & I, II \\
				...
				\cite{ott2020phase} & 62  & 23 weeks & Melanoma, Non-small Cell Lung Cancer, or Bladder Cancer & Advanced & I \\
				...
				\cite{poran2020combined} & 21  & 104 weeks & Melanoma & Advanced & I \\
				
				\cite{engelhard2020mhc} & 12  & 12 weeks follow-up until 26 weeks & Melanoma &- & I \\
				...
				\cite{keskin2019neoantigen} & 8  & 20 weeks & Glioblastoma & -& I \\
